 ...
 * @author ZADO
 */
public class OngkirDokumen implements Ongkir {
    ...
    public void hitungOngkir(int berat, String lokasi1, String lokasi2, int fragile) {
        try {
            ...
            float HargaKg, HargaKgBarang;
            HargaKg = new Produk(3).getHargaSatuan();
            HargaKgBarang = new Produk(2).getHargaSatuan();
            ...
            if (berat == 1) {
                ...
                if (fragileBool) {
                    if (jarak <= 50) {
                        this.total = "" + HargaKgBarang * fragilePercentage;
                    } else {
                        double jarakFix = jarak - 50;
                        float hargaJarak = (float) (HargaKgBarang + (jarakFix / 25) * 750);
                        float hargaTotal = (float) ((hargaJarak * berat) * fragilePercentage);
                        this.total = "" + hargaTotal;
                    }
                } else {
                    if (jarak <= 50) {
                        this.total = "" + HargaKgBarang;
                    } else {
                        double jarakFix = jarak - 50;
                        float hargaJarak = (float) (HargaKgBarang + (jarakFix / 25) * 750);
                        float hargaTotal = (float) ((hargaJarak * berat));
